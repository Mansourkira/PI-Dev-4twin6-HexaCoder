...
export default function DetailsTeacher() {
 ...
 tuto:false,poste:"",
  projects:null});
   const [project , SetProjects] = useState([{project_name:"",project_theme:"",project_link:"",team:[],state_qualified:false,date_of_creation:null,teacher:null,logo:"",Marketing:"",description:"",project_option:""}]);

  useEffect(() => {

        axios.get("http://localhost:8095/api/teachers/"+id)
      .then((data) =>{SetTeacher(data.data.teacher);
      console.log("data",data.data.teacher);})
...
axios.get("http://localhost:8095/api/teachers/getProject/"+obj)
...
<i class="fa fa-ban"></i>)
  ...
  <a href="#" class="list-group-item list-group-item-action active" aria-current="true">
    <div class="d-flex w-100 justify-content-between">
      <h5 class="mb-1">{teacher.project}</h5>
