...
import MyPagination from './Paginator';
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              ...
              <MyPagination totPages={2} currentPage={3} pageClicked={(ele) => {}}>
              <tbody>
              ...
              {projects.map(project => (
                    ...
                    <tr>
                      <td>{project.project_name}</td>
                        ...
                        <td><button onClick={handleSubmit(project)}  className="btn btn-success"><i class="bi bi-tools"></i></button> </td> 
                    </tr>
                    ))}
