...
export default function AdminTable() {
  ...
  const handleSubmit3 = (id) => (event) => {
    console.log(id[0]);
    axios
      .get("http://localhost:8095/projects/sendmail/" + id[0])
      .then((res) => {
        console.log(res);
        console.log(res.data);
      });
                ...
                <tbody>
                  {projects.map((project) => (
                    <tr>
                      ...
                      <td>
                        <a href={project.project_link}>Link to project</a>
                      </td>

                      <td>
                        <button
                          onClick={handleSubmit2(project)}
                      ...
                      <button
                        onClick={handleSubmit3(project.Team.map((e) => e._id))}
